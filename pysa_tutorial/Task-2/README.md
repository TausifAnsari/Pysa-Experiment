...
1. Go to task - 2 directory, if you are in the root directory
...
3. After activating the virtual environment, go to the second task (Task - 2)
...
4. On the left navigation bar, Expand pysa-tutorial -> Task-2, then open views.py file from Task-2 directory.
