...
### Refer to the [this](https://github.com/TausifAnsari/Pysa-Experiment/blob/main/pysa_tutorial/Task-3/Document/PysaExperiment-Task3.pdf) step-by-step guide if you are not able to run Pysa or Dynamic debugger.
...
1. Go to task - 3 directory, if you are in the root directory
...
3. After activating the virtual environment, go to the third task (Task - 3)
...
4. On the left navigation bar, Expand pysa-tutorial -> Task-3, then open views.py file from Task-3 directory.
